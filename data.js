/* ============================================================================
   PortMap — данные
   ----------------------------------------------------------------------------
   Можно править прямо в приложении (Админ-режим), а можно здесь руками.
   Если правишь в приложении и жмёшь «Сохранить на GitHub» — этот файл
   перезаписывается автоматически.
============================================================================ */

/* Версия данных. Меняется автоматически при каждом сохранении — нужна для синхронизации между устройствами. Руками не трогай. */
window.DATA_VERSION = 1;

/* Справочник VLAN: номер → название. Показывается подсказкой при нажатии на VLAN. */
window.VLANS = {
  1:   "default",
  2:   "FITNES",
  3:   "CAMERA",
...
/* Свитчи. Поля порта: port, vlan, ip, mac, host, channel (камера, напр. D4), off (выключен). */
window.SWITCHES = [
